...
`docs/marketing/marketing.md`, `docs/planning/HANDOFF_Document.md`, `docs/planning/Issues.md`,
`docs/marketing/hooked_throttleiq.md`, `docs/architecture/backend_options.md`, live code) — every
...
That's not true internationally — `docs/planning/HANDOFF_Document.md`'s own
...
of marketing material written for this app (see `docs/marketing/marketing.md` §4 and
...
(`docs/architecture/backend_options.md`) that's been sitting unresolved across multiple
...
segment identified in `docs/marketing/marketing.md` §2 — daily BD commuters on
...
growth-channel idea in `docs/marketing/marketing.md` §5 (Facebook groups, club
...
`docs/marketing/hooked_throttleiq.md` already did the hard, honest work here: no push
...
create an install that opens the app twice and stops — `docs/marketing/marketing.md`
...
(`docs/planning/Issues.md` §24). That's not a criticism of the work — the audits
...
Crash detection is the strongest emotional hook this app has (`docs/marketing/marketing.md`
...
twice: once in the Settings screen copy itself (fixed per `docs/planning/Issues.md`
...
(`docs/architecture/backend_options.md`'s own $20–30/month estimate was for 10K DAU —
...
- **At least one retention fix shipped** (a maintenance-due push
  ...
  `docs/marketing/hooked_throttleiq.md`) before the next acquisition push, so
