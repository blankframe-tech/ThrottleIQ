...
Motorcycle owners without reliable odometers (old vehicles), or people who's liveihood is based on ride sharing who can see the true per km cost of riding (fuel + degradations of engine oil, air filtre, tyres, break shoe, etc etc)


Secondary

Enthusiasts / touring riders who share group rides, save interesting routes that can be sent to ither riders who also want to take that route. 
