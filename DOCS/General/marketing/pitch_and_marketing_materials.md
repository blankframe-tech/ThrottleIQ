...
`docs/marketing/marketing.md`, `store_listing/store_listing.md`, `DOCS/Handoff for agents and Todos/HANDOFF_Document.md`,
...
`DOCS/Handoff for agents and Todos/issues_fixed.md` §24/§33). Every other claim below is checked against what
...
- A recent security/bug-hardening pass closed 16 of 18 findings, including
  two that would have been launch-blocking (`DOCS/Handoff for agents and Todos/issues_fixed.md` §33) — this is
...
- Wire the crash-detection escalation (SMS/email if an emergency contact
  ...
  decision, not on code (see `DOCS/For Devs and Contributers/architecture/backend_options.md`).
