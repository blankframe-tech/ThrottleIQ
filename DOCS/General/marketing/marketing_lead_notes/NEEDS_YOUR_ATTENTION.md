...
Per `DOCS/Handoff for agents and Todos/HANDOFF_Document.md` (2026-08-29): versionCode 3
...
claims (see `issues_fixed.md` §57), but while doing that found something more
...
`DOCS/Handoff for agents and Todos/issues_fixed.md` §55 flags that 30 QA test-rider accounts with
...
`issues_open.md` as needing an explicit go-ahead, which is a production-data
